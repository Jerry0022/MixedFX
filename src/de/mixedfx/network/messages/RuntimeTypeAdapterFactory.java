 ...
 * Create a {@code RuntimeTypeAdapter} by passing the base type and type field name to the
...
public final class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory
{
	 ...
	 *             if either {@code type} or {@code label} have already been registered on this type
	 *             adapter.
	 */
	 ...
	 *
	 * @throws IllegalArgumentException
	 *             if either {@code type} or its simple name have already been registered on this
	 *             type adapter.
	 */
