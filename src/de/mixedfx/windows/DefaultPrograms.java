...
public class DefaultPrograms
{
	...
	public static final Program	TUNNGLE	= new Program(FileObject.create().setPath("C:\\Program Files (x86)\\Tunngle").setFullName("Tunngle.exe"), "Tunngle.exe", "TunngleService");
}
