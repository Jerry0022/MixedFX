...
import de.mixedfx.java.TextToSpeech.Language;
...
public class TTSConfig
{
	...
	/**
	 * German and English as female or male voice are available (see also {@link TextToSpeech.Language}). Default is {@link Language#ENGLISH_US_FEMALE}. If null the voice is auto detected from the
	 * input text. Pay attention auto detection, see also {@link #DETECTLANGUAGE_API_KEY}.
	 */
	public Language lang = Language.ENGLISH_US_FEMALE;

	/**
	 * If true a male voice speaks.
	 */
