...
public final class TimeoutController
{
	...
	/**
	 * Executes <code>task</code>. Waits for <code>timeout</code> milliseconds for the task to end and returns. If the task does not return in time,
	 * the thread is interrupted and an Exception is thrown. The caller should override the Thread.interrupt() method to something that quickly makes
