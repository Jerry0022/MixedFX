...
public class LayoutManager {
     ...
     *
     * @param layout The name of the layout. If null a layout with the name {@link LayoutManager#defaultLayoutName} is created!
     */
     ...
     *
     * @param usualImage The layout specific file as FileObject.
     ...
     *
     * @param layout The name of the layout which shall be deleted.
    ...
    /**
     * @param oldName Old name of the layout (folder).
     * @param newName New name of the layout (folder).
    ...
    /**
     * @param id    An id containing only letters and numbers.
     * @param image The image to write to the current layout.
     */
