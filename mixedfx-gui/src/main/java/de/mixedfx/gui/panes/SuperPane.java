...
public class SuperPane extends StackPane {
     ...
     *
     * @param content The content which shall be shown.
     */
     ...
     *
     * @param content
     * @param loadScreen Can be a {@link Dynamic} to be informed about its lifecycle. The Load Screen is not part of the scene graph until {SuperPane
     ...
     *
     * @param child Any node which is in the scene graph.
     ...
     *
     * @param dialogue The dialogue to close.
     */
     ...
     * </p>
     *
     * @param dynamic The node (if {@link Dynamic} it will be informed) which shall be shown on top of the SuperPane
     */
     ...
     *
     * @param task The task which shall be executed. Maybe it is not executed immediately because more than {@link SuperPane#taskMaxParallel} are
    ...
    /**
     * @param dynamic
     * @param darkenLastLayer Only has an effect if there is not already a layer darkened
     */
     ...
     * Sets the Background.
     *
     * @param background In contrast to {@link Region#setBackground(javafx.scene.layout.Background)} this can be any Node.
     */
     ...
     *
     * @param onLoadingDone Any runnable which is called from the FXThread (therefore do not execute long running tasks here)!
     */
