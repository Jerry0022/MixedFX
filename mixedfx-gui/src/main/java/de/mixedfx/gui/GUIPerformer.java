...
public class GUIPerformer {
     ...
     * the rootNode is set.
     *
     * @param stage     The minWidthProperty() and minHeightProperty() are bound and {@link Stage#setScene(Scene)} is called.
     * @param rootNode  The minSize of the root node is set once to minWidth and minHeight.
     * @param minWidth  The starting minimum width. If you want to change the minimum width later call rootNode.setMinSize() or bind it.
     * @param minHeight The starting minimum height. If you want to change the minimum height later call rootNode.setMinSize() or bind it.
