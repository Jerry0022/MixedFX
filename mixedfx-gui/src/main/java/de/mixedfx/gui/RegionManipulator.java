...
public class RegionManipulator {
     ...
     *
     * @param region   Region which sizes shall be bound.
     * @param property Double to which the min, pref and max width of the region shall be bound.
     */
     ...
     *
     * @param region   Region which sizes shall be bound.
     * @param property Double to which the min, pref and max height of the region shall be bound.
     */
     ...
     *
     * @param region Region whose background shall be set.
     * @param image  Image which shall be the background of the region.
     */
