...
public class TTSConfig
{
	...
	/**
	 * German and English as female or male voice are available. Default is {@link Language#ENGLISH}. If null the voice is auto detected from the input texttospeech. Pay attention auto detection, see also
